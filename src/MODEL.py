...
class NNMod(torch.nn.Module):
   def __init__(self,maxnumtype,outputneuron,atomtype,nblock,nl,dropout_p,actfun,initpot=0.0, initstd=1.0,table_norm=True):
      """
      ...
      self.register_buffer("initstd", torch.Tensor([initstd]))
