...
- **Finite-field simulation** Then we need to use the trained PES model to perform finite-field MD simulations with LAMMPS or ASE. For LAMMPS compilation or the ASE interface with FIREANN model, please refer to the manual in main branch.
